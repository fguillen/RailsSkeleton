...
class Admin::UserMailerTest < ActionMailer::TestCase
  def test_on_new_article
    ...
    # write_fixture("/notification/admin/on_new_article.txt", email.body.encoded)
    assert_equal(File.read(fixture("/notification/admin/on_new_article.txt")), email.body.encoded)
  end
end
